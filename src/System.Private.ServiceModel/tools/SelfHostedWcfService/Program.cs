...
namespace SelfHostedWCFService
{
    public class SelfHostedWCFService
    {
        ...
        private static void Main()
        {
            ...
            CreateHost<BasicHttpRpcEncSingleNsServiceHost, RpcEncSingleNsService>("BasicHttpRpcEncSingleNs.svc", httpBaseAddress);
            CreateHost<BasicHttpRpcEncMultiNsServiceHost, RpcEncMultiNsService>("BasicHttpRpcEncMultiNs.svc", httpBaseAddress);
